    ...
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-stock px-5 py-14 sm:px-8 sm:py-20">
      ...
      <FadeIn className="relative z-10 w-full max-w-md" delay="0.1s">
        <div className="text-center">
          ...
          <span className="register">Enlistment — New Recruit</span>
          <h1 className="mt-3 text-3xl font-extrabold tracking-tight text-ink sm:text-4xl">Sign Up</h1>
          <p className="mt-2 text-ink-soft">Create a free account and start training</p>
        </div>
